...
@Table(
        name = "activity",
        indexes = {
                @Index(name = "idx_activity_creator_id", columnList = "creator_id"),
                @Index(name = "idx_activity_start_time", columnList = "startTime"),
                @Index(name = "idx_activity_end_time", columnList = "endTime"),
                @Index(name = "idx_activity_last_updated", columnList = "last_updated"),
...
public class Activity implements Serializable {
    ...
    public Activity(UUID id, String title, OffsetDateTime startTime, OffsetDateTime endTime, Location location, String note, User creator, String icon) {
        ...
        this.location = location; this.note = note; this.creator = creator;
        this.createdAt = Instant.now(); this.lastUpdated = Instant.now(); this.icon = icon;
    }
    ...
    public Activity(UUID id, String title, OffsetDateTime startTime, OffsetDateTime endTime, Location location, String note, User creator, String icon, String clientTimezone) {
        this.id = id; this.title = title; this.startTime = startTime; this.endTime = endTime;
        this.location = location; this.note = note; this.creator = creator;
        this.createdAt = Instant.now(); this.lastUpdated = Instant.now(); this.icon = icon; this.clientTimezone = clientTimezone;
    }
}
