...
/**
 * Service for querying chat data from the monolith via Feign client.
 * <p>
 * In the monolith, this used in-process events (ApplicationEventPublisher)
 * to communicate with the Chat module. In the activity-service microservice,
 * the Chat module stays in the monolith, so we use a Feign client instead.
 * <p>
