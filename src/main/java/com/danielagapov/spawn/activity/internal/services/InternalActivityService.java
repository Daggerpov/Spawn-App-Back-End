...
@Service
public class InternalActivityService implements IInternalActivityService {
    ...
    @Autowired
    public InternalActivityService(IActivityRepository repository, IActivityTypeRepository activityTypeRepository,
